...
def ex_interventions_sirnetwork_1():
    ...
    fig.savefig("img/interventions_sir_network.png", dpi=300)
    
    # Animate infection spread:
    ani = animate_network_spread(model_net, interval=200)
    ani.save("img/interventions_sir_network_spread.gif", writer="pillow", fps=1)
...
def ex_interventions_seird_1():
    ...
    fig.savefig("img/interventions_seird.png", dpi=300)

    # Animate infection spread:
    ani = animate_network_spread(model_seird, interval=200, model_type="SEIRD")
    ani.save("img/interventions_seird_spread.gif", writer="pillow", fps=1)
...
def ex_interventions_seiard_1():
    ...
    fig.savefig("img/interventions_seiard.png", dpi=300)

    # Animate infection spread:
    ani = animate_network_spread(model_seiard, interval=200, model_type="SEIARD")
    ani.save("img/interventions_seiard_spread.gif", writer="pillow", fps=1)
